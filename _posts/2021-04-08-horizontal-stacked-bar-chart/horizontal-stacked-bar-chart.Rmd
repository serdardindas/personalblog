...
Now we can adjust the appearance of colors in this stage. You can use google chrome extension ["Eye Dropper" ]{.important} to extract colors codes. I chose colors to match the original.
